...
/**
 * Utility Class for faking a Typoscript Frontend Controller to use api functionality
 *
...
class FakeTypoScriptFrontendController
{
    ...
    function __construct($id = 0) {
        ...
        // Setting up TS FE controller to get the base url with a given page id
        $GLOBALS['TSFE'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(
            'TYPO3\\CMS\\Frontend\\Controller\\TypoScriptFrontendController',
            $GLOBALS['TYPO3_CONF_VARS'], $id, 0, 1
        );
