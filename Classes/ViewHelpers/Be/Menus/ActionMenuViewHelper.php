<?php
namespace ROQUIN\RoqRedirect\ViewHelpers\Be\Menus;
...
class ActionMenuViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractTagBasedViewHelper implements \TYPO3\CMS\Fluid\Core\ViewHelper\Facets\ChildNodeAccessInterface
{
    ...
    public function render() {
        ...
        return '<div class="docheader-funcmenu">' . $GLOBALS['LANG']->sL('LLL:EXT:roq_redirect/Resources/Private/Language/locallang.xlf:tx_roqredirect_domain_model_redirect.select_site') . ' ' . $this->tag->render() . '</div>';
    }
}
