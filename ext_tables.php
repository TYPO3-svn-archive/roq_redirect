...
$TCA['tx_roqredirect_domain_model_redirect'] = array(
	'ctrl' => array(
        ...
        'typeicons' => array (
            '0' => t3lib_extMgm::extRelPath($_EXTKEY) . 'Resources/Public/Icons/page_white_go.png',
            '1' => t3lib_extMgm::extRelPath($_EXTKEY) . 'Resources/Public/Icons/tx_roqredirect_domain_model_redirect.png',
            '2' => t3lib_extMgm::extRelPath($_EXTKEY) . 'Resources/Public/Icons/folder_go.png',
        ),
